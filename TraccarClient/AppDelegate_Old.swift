...
@UIApplicationMain
class AppDelegate_Old: UIResponder, UIApplicationDelegate, PositionProviderDelegate, KBeaconMgrDelegate {
    ...
    public var mBeaconsArray = [KBeacon]()
    
    static var instance: AppDelegate_Old {
        return UIApplication.shared.delegate as! AppDelegate_Old
    }
    ...
    func onBeaconDiscovered(_ beacons:[KBeacon])
    {
        ...
        for beacon in beacons
        {
            ...
            if mBeaconsDictory[beacon.uuidString] != nil
            {
                ...
                trackingController?.mac += "," + beacon.name
